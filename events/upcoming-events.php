...
$filterby = $ecategory[2]['ID']; 

$allevent = $Common->get_post(EVENTS);
$upcomingevents = array_filter($allevent, function ($var) {
    return ($var['event_id'] == 2);
});

// Sort upcoming events by 'post_order_no'
usort($upcomingevents, function ($a, $b) {
    return $a['post_order_no'] <=> $b['post_order_no'];
});
?>
...
<html lang="en">
<head>
    <title>Upcoming Events - Information and Cultural Affairs Department</title>
                            ...
                            <div class="upcoming_event_blocks">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer border-0 bg-transparent">
                                        <a href="<?php echo $base_url; ?>events/upcoming-events/<?php echo generate_slug($event['title']); ?>"
