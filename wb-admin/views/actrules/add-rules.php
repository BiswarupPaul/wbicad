...
if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'edit') {
    ...
    $get_post = $Common->get_post(ACTRULES, $reqId)[0];
...
<div class="row align-items-center g-2 mb-3">
    ...
    <div class="col-md-3">
        ...
        <a href="layout.php?p=actrules-list-rules" class="btn btn-primary float-end">

            <i class="fa-solid fa-plus me-1"></i>All Act & Rules
    ...
    <div class="publish-row">
        ...
        <div class="row align-items-center justify-align-center">
            ...
            <div class="col-md-4 text-end">
                ...
                <input type="hidden" name="action" value="add_update_act_rules" />
                ...
                <input type="hidden" name="redirect" value="layout.php?p=actrules-list-rules" />
