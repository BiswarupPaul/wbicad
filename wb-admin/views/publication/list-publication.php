 ...
 */
$get_post = $Common->get_post(PUBLICATION);
?>
...
<div class="row align-items-center">
    ...
    <div class="col-md-3">
        <a href="layout.php?p=publication-add-publication" class="btn btn-primary float-end"><i class="fa-solid fa-plus me-1"></i>Add New</a>
    </div>
</div>
        ...
        <tbody>
            ...
            foreach ($get_post as $post):
                ...
                <tr>
                    ...
                    <td>
                        <a href="layout.php?p=publication-add-publication&page=edit&id=<?php echo $post['ID']; ?>" class="link-primary">
                            <i class="fa-regular fa-pen-to-square"></i>
                        </a>
                        <a href="javascript:void(0);" data-table="<?php echo PUBLICATION; ?>" data-id="<?php echo $post['ID']; ?>" onclick="deletePost(this);" class="link-danger">
