...
if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'edit') {
    ...
    $get_post = $Common->get_post(PUBLICATION, $reqId)[0];
...
<div class="row align-items-center g-2 mb-3">
    ...
    <div class="col-md-3">
        ...
        <a href="layout.php?p=publication-list-publication" class="btn btn-primary float-end">

            <i class="fa-solid fa-plus me-1"></i>All Publication
...
<form method="post" id="postForm" enctype="multipart/form-data">
    ...
    <div class="item_name">
        ...
        <div class="whitebox mb-4">
            ...
            <input type="text" class="form-control datepicker paste-disabled" name="post[date]" id="post[date]" value="<?php echo isset($get_post['date']) ? $get_post['date'] : ''; ?>">
    ...
    <div class="publish-row">
        ...
        <div class="row align-items-center justify-align-center">
            ...
            <div class="col-md-4 text-end">
                ...
                <input type="hidden" name="action" value="add_update_publication" />
                ...
                <input type="hidden" name="redirect" value="layout.php?p=publication-list-publication" />
