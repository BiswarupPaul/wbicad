...
if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'edit') {
    ...
    $get_post = $Common->get_post(BUDGET, $reqId)[0];
...
<div class="row align-items-center g-2 mb-3">
    ...
    <div class="col-md-3">
        ...
        <a href="layout.php?p=budget-list-budget" class="btn btn-primary float-end">

            <i class="fa-solid fa-plus me-1"></i>All Budget
    ...
    <div class="publish-row">
        ...
        <div class="row align-items-center justify-align-center">
            ...
            <div class="col-md-4 text-end">
                ...
                <input type="hidden" name="action" value="add_update_budget" />
                ...
                <input type="hidden" name="redirect" value="layout.php?p=budget-list-budget" />
...
//                        }
        ...
        // Regular expression for validating URLs including subdomains and optional paths
