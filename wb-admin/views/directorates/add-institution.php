...
if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'edit') {
    ...
    $get_post = $Common->get_post(INSTITUTION, $reqId)[0];
...
<div class="row align-items-center g-2 mb-3">
    ...
    <div class="col-md-3">
        ...
        <a href="layout.php?p=directorates-list-institution" class="btn btn-primary float-end">

            <i class="fa-solid fa-plus me-1"></i>All Institutions
        ...
        <div class="whitebox mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select class="form-control paste-disabled" name="post[directorate_id]">
                ...
                <div class="col-md-8 mb-4">
                    ...
                    <div class="border shadow position-relative">
                        ...
                        <div class="img_holder" id="image-preview" <?php echo $logo_fullPath; ?>>
    ...
    <div class="publish-row">
        ...
        <div class="row align-items-center justify-align-center">
            ...
            <div class="col-md-4 text-end">
                ...
                <input type="hidden" name="action" value="add_update_directorates_institution" />
                ...
                <input type="hidden" name="redirect" value="layout.php?p=directorates-list-institution" />
