...
<html lang="en">
    <head>
        <title>Institution/Academy - Information and Cultural Affairs Department</title>
        ...
        <div class="mid">
            <div class="sectiongap">
                <div class="dept_list academy">
                    <div class="container">
                        <h2><strong>Information Institution/Academy</strong></h2>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-10">
                                <?php if (!empty($offices)) { ?>
                                    <h4><u>Name of the Offices under Directorate of Information:</u></h4>
