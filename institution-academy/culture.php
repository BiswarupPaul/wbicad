...
<html lang="en">
    <head>
        <title>Institution/Academy-Culture - Information and Cultural Affairs Department</title>
        ...
        <div class="mid">
            <div class="sectiongap">
                <div class="dept_list academy">
                    <div class="container">
                        <h2><strong>Culture Institution/Academy</strong></h2>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-10">
                                <?php if (!empty($offices)) { ?>
                                    <h4><u>Name of the Offices under Directorate of Culture:</u></h4>
