    ...
    <body>
        ...
        <div class="mid tick">
            <div class="sectiongap">
                <div class="container">
                    <h2><strong><?php echo $directorates[4]['title']; ?></strong></h2>
                    <div class="row mb-3">
                        <div class="col-md-3">
                    ...
                    <?php if (!empty($directorates[4]['directorate_brief'])) { ?>
                        <div class="tick_double">
                            <?php echo $directorates[4]['directorate_brief']; ?>
                        </div>
                    <?php } ?>

                    <?php if (!empty($institution)) { ?>
                        <div class="mt-4">
                            <h2><strong><?php echo $directorates[4]['title']; ?> Institution/Academy</strong></h2>
                    ...
                    <?php if (!empty($offices)) { ?>
                        <div class="mt-sm-5 mt-0">
                            <h2><strong>Name of the Offices under <?php echo $directorates[4]['title']; ?>:</strong></h2>
