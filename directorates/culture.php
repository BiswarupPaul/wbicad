...
<html lang="en">
    <head>
        <title>Culture - Information and Cultural Affairs Department</title>
    ...
    <body>
        ...
        <div class="mid tick">
            <div class="sectiongap">
                <div class="container">
                    <h2><strong><?php echo $directorates[1]['title']; ?></strong></h2>
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <img class="img-fluid" src="<?php echo ASSET_URL . $directorates[1]['about_image']; ?>" alt="">
                        </div>
                        <div class="col-md-6">
                            <?php echo $directorates[1]['about_directorate']; ?>
                        </div>
                        <div class="col-md-3">
                            <div class="directorate_pic">
                                <img src="<?php echo ASSET_URL . $directorates[1]['directorate_image']; ?>" alt="" class="img-fluid w-75">
                                <h4><?php echo $directorates[1]['directorate_designation']; ?></h4>
                                <h6><span><?php echo $directorates[1]['directorate_name']; ?></span></h6>
                                <p><span><i class="fa-solid fa-location-dot"></i> Address:</span> <?php echo $directorates[1]['directorate_office_address']; ?></p>
                            </div>
                        </div>
                    </div>

                    <?php if (!empty($directorates[1]['directorate_brief'])) { ?>
                        <div class="tick_double">
                            <?php echo $directorates[1]['directorate_brief']; ?>
                        </div>
                    <?php } ?>

                    <?php if (!empty($institution)) { ?>
                        <div class="mt-4">
                            <h2><strong><?php echo $directorates[1]['title']; ?> Institution/Academy</strong></h2>
                    ...
                    <?php if (!empty($directorates[1]['bottom_content'])) { ?>
                        <div class="mt-sm-5">
                            <?php echo $directorates[1]['bottom_content']; ?>
                        </div>
                    <?php } ?>

                    <?php if (!empty($offices)) { ?>
                        <div class="mt-sm-5 mt-0">
                            <h2><strong>Name of the Offices under <?php echo $directorates[1]['title']; ?>:</strong></h2>
